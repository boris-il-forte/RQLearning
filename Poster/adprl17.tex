...
\begin{center}
 \listhead{\Large Idea}\\
\end{center}
  \textbf{To improve estimates, exploit:}
\begin{center}
  \tikz[baseline]
  {
    \node[] (G1) {\color{blue800} \Large Structure of the Bellman update};
    \node[right=4cm of G1] (G2) {\color{red} \Large Uncertainty of the estimation};
  } 
\end{center}
...
\begin{minipage}[t]{.6\textwidth}
   Exploit the \HL{variance of estimation} to set the learning rate:
   \begin{enumerate}
