...
\item Split the action-value function estimate \textbf{two components}:
  \begin{itemize}
...
\begin{center}
  ...
  \vspace{.25cm}
  $\Rtilde(x,u)=\underset{\strut\mathclap{x'\sim \Pmodel(x'|x,u)}}{\mathbb{E}}\left[ r(x,u,x')\right]$\hspace{0.7cm}
...
\begin{center}
  \tikz[baseline]
  {
    \node[] (Q1) {\color{blue} \Large \textbf{Q-Learning:}};
    \node[right=0.5cm of Q1] (Q2) {\Large $\beta_t=\alpha_t$};
    
    \node[right=1.5cm of Q2] (RQ1) {\color{lightgreen} \Large \textbf{RQ-Learning:}};
    \node[right=0.5cm of RQ1] (RQ2) {\Large $\beta_t\neq\alpha_t$};
    
    \node[right=1.5cm of RQ2] (RQD1) {\color{newbrown} \Large \textbf{$\text{RQ}_\delta$-Learning:}};
...
\begin{minipage}[t]{\textwidth}
   ...
   \begin{minipage}{.45\textwidth}
      \begin{itemize}
	\item \textbf{\color{lightgreen}Inversely} proportional $\beta$:~~
	 \tikz[baseline]
	  {
	    \node[draw=blue800, line width=0.6mm, inner sep=5pt] (G1) {$\beta_t=\dfrac{\sigma_e^2(t)}{\sigma_e^2(t)+\eta}$}
	  }
      \end{itemize}
   \end{minipage}
   \begin{minipage}{.45\textwidth}
      \begin{itemize}
	\item \textbf{\color{newbrown}Directly} proportional $\delta$:~~
	 \tikz[baseline]
	 {
...
\begin{minipage}{0.6\textwidth}
  \begin{center}
    ...
    %
    \begin{minipage}{0.5\textwidth}
	\includegraphics[scale=0.55]{./imgs/gridHasselt/RQ_1.pdf}
	\includegraphics[scale=0.55]{./imgs/gridHasselt/RQ_08.pdf}
    \end{minipage}
  \end{center}
\end{minipage}
...
\begin{center}
  ...
  \hfill
  \begin{minipage}{0.33\textwidth}
    \includegraphics[scale=0.55]{./imgs/doubleChain/lrs-1.pdf}
    \includegraphics[scale=0.55]{./imgs/doubleChain/lrs-51.pdf}
  \end{minipage}
  \hfill
  \begin{minipage}{0.33\textwidth}
