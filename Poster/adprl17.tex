...
%    \input{./tests/experiments/internetAds-impressions.tex}\hspace{.1cm}
%    \input{./tests/experiments/internetAds-actions.tex}\hspace{.1cm} 
%    \input{./tests/experiments/internetAds-probs.tex}
%    
%  \centering \textbf{Sponsored Search Auctions}\\
%    \input{./tests/experiments/sponsoredSearch.tex}
% \end{minipage}\hfill
% \begin{minipage}[t]{.525\textwidth}
%  \listhead{Markov Decision Processes}
% 
%  \centering \textbf{Grid World}\\
%    \input{./tests/experiments/gridexp08-ng.tex}
%    \input{./tests/experiments/gridexp08-g.tex}
%    \input{./tests/experiments/gridexp08-g-sigma1.tex}
% 
%  \centering \textbf{Forex}\\
%    \vspace{.1cm}
%    \input{./tests/experiments/forexTrain.tex}\hspace{.2cm}
%    \input{./tests/experiments/forexTest.tex}
\end{minipage}
}
% 
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
