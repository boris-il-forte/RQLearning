...
As shown in the plot in Figure~\ref{maxq_gridhole} the QD-learning provides the best Q-function estimation in few steps. However, an inaccurate estimation of the Q-function does not necessarily imply a worse optimal policy estimation. Indeed, as we can see in Figure~\ref{avg_rew_gridhole}, Q-learning and SpeedyQ-learning have the better performance in terms of average reward per step, while QD-learning outperforms the Double Q-learning and the WQ-learning algorithms.
