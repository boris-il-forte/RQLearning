...
\begin{minipage}{\columnwidth}
\centering
  \subfigure[$\alpha = \dfrac{1}{n(s,a)}$\label{F:hole_1}]{\includegraphics[scale=.7]{./imgs/gridHole/grid_hole1.pdf}}\hspace{-.5cm}
  \subfigure[$\alpha = \dfrac{1}{n(s,a)^{0.8}}$\label{F:hole_08}]{\includegraphics[scale=.7]{./imgs/gridHole/grid_hole08.pdf}}
\end{minipage}
  \caption{Mean reward per step (top) and maximum action-value estimate in the initial state (bottom) of all the other algorithms and of the best setting of \alg for this experiment. Results are averaged over 10000 experiments.}
  \label{F:hole}
\end{figure}
